window.MB_SITE = {
  ...
  checkout: {
    ...
    vipBaddie: "https://buy.stripe.com/5kQ28r4xTdlF6GS4Pk1RC0r",
  },
  contactEmail: "support@menopausebaddies.com",
};

window.MB_LINKS = {
  waitlist: window.MB_SITE.waitlistUrl,
  clubMemberCheckout: window.MB_SITE.checkout.clubMember,
  vipBaddieCheckout: window.MB_SITE.checkout.vipBaddie,
  contact: `mailto:${window.MB_SITE.contactEmail}`,
};
